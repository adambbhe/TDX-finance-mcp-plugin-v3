...
- `tdx_api_data(entry="tdxf10_gg_rdtc", fixedTag="sjcd")`：验证政策、产业、海外映射、事件催化是否仍在发酵
- `tdx_api_data(entry="tdxf10_gg_ybpj", fixedTag="yjyg")`：验证公告、订单、回购、减持、停复牌等是否改变预期
- `tdx_api_data(entry="tdxf10_gg_ybpj", fixedTag="yzyq")`：验证券商是否开始集中覆盖或一致预期是否已过高
