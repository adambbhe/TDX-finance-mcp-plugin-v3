...
console.log("== 分档 B ==");
ok(B.fengLiu(0.02)==="≥1.5%"&&B.fengLiu(0.01)==="0.8-1.5%"&&B.fengLiu(0.006)==="0.4-0.8%"&&B.fengLiu(0.002)==="<0.4%","封流比4档(v3.2)");
ok(B.fcb(40)==="≥32"&&B.fcb(20)==="16-32"&&B.fcb(10)==="8-16"&&B.fcb(5)==="<8","封成比4档(v3.2)");
...
const hi=a.find(x=>x.bucket==="≥1.5%"),lo=a.find(x=>x.bucket==="0.4-0.8%");
ok(hi.n===2&&Math.abs(hi.sealRate-0.5)<1e-9&&Math.abs(hi.avgChg-6.5)<1e-9,"≥1.5%档: n=2 封板率50% 均涨6.5%");
ok(lo.n===1&&lo.sealRate===0&&lo.avgChg===-2,"0.4-0.8%档: n=1 封板率0% 均涨-2%");
ok(a[0].bucket==="≥1.5%","按封板率降序：高封流比在前");
